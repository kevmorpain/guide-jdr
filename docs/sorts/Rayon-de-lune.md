...
- **Portée** : 36 mètres
- **Composantes** : Verbale, Somatique, Matérielle (plusieurs graines de pavot et un morceau de feldspath opalescent)
...
***À plus haut niveau*** : Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 3 ou supérieur, les dégâts augmentent de 1d10 pour chaque niveau d'emplacement au-delà du niveau 2.